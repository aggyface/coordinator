...
and more reliable. Each is a self-contained Claude Code session.
...
**Purpose:** Not a script — a workflow pattern. Ensures each Claude Code session
stays focused on its prompt and doesn't drift into unrelated refactoring.

**Template to use at the start of every Claude Code session:**
...
**Why this matters:** Claude Code will see the full GEMINI.md and the relevant
